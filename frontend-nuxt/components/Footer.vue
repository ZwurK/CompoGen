    ...
    <footer class="px-4 divide-y text-gray-800">
      <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div class="lg:w-1/3">
          <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
            <div class="flex items-center justify-center w-12 h-12 rounded-full">
              <img class="flex-shrink-0 w-9 h-9 rounded-md text-blue-50" src="/images/logo.png">
            </div>
        ...
        <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div class="space-y-3">
            <h3 class="uppercase text-gray-900">Product</h3>
            <ul class="space-y-1">
              <li>
          ...
          <div class="space-y-3">
            <h3 class="tracki uppercase text-gray-900">Company</h3>
            <ul class="space-y-1">
              <li>
                <nuxt-link rel="noopener noreferrer" to="/legal">Legal Notices</nuxt-link>
              </li>
            </ul>
          </div>
          <div class="space-y-3">
      ...
      <div class="py-6 text-sm text-center text-gray-600">© 2023 GenElements All rights reserved.</div>
    </footer>
