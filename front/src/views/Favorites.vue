<template>
  <div class="p-10">
    <h1 class="text-4xl font-bold text-pink-400 mb-10">Favorites</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div v-for="component in filteredComponents" :key="component.id" class="border border-gray-300 rounded-lg p-4">
        <div class="h-32 rounded-md mb-2">
          <iframe sandbox="allow-same-origin allow-scripts" :srcdoc="generateSrcDoc(component.framework, component.code)"
